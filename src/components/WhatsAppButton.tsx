...
export default function WhatsAppButton() {
  ...
  const defaultMessage = 'Merhaba, TTK Hukuk Bürosu ile iletişime geçmek istiyorum.'
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Genellikle hemen yanıt verir</p>
                  </div>
                </div>
                <button
            ...
            <div className="p-4 bg-[#E5DDD5]">
              <div className="bg-white rounded-lg p-3 shadow-sm max-w-[85%]">
                <p className="text-gray-800 text-sm">
                  Merhaba! 👋 TTK Hukuk Bürosu'na hoş geldiniz. Size nasıl yardımcı olabiliriz?
                </p>
                <p className="text-gray-500 text-xs mt-1 text-right">Şimdi</p>
              </div>
            </div>
